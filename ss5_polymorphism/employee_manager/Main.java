...
//    static ArrayList<ProductionEmployee> productionEmployees = new ArrayList<>();
    ...
    private static <T extends Employee> ArrayList<T> filterEmployees(Class<T> type) {
    ...
    private static void menuSortBySalary() {
        ...
        while (true) {
            ...
            switch (choose) {
                case 1:
                    sortList(filterEmployees(ManagementEmployee.class)); // sắp xếp NV quản lý
                    break;
                case 2:
                    sortList(filterEmployees(ProductionEmployee.class)); // sắp xếp NV sản xuất
                    break;
                case 3:
                    sortList(employees); // sắp xếp toàn bộ
                    break;
                case 4:
                    return;
                default:
